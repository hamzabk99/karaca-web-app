<template>
  <div class="login-register-form">
    ...
    <!-- Register Form -->
    <div v-if="activeTab === 'register' && !isAccountCreated" class="form register-form">
    ...
    <!-- Hesap Oluşturuldu Mesajı -->
    <div v-if="isAccountCreated" class="login-success-message">
      Hesap Oluşturuldu!
    </div>
  </div>
</template>
...
import { useAuthStore } from '../stores/authStore'; // Pinia store'u içe aktar
...
export default defineComponent({
  ...
  setup() {
    ...
    const isLoggedIn = ref(false); // Giriş durumunu takip et
    const isAccountCreated = ref(false); // Hesap oluşturma durumunu takip et
    ...
    const handleLogin = async () => {
      ...
      if (authStore.user) {
        console.log('Giriş başarılı:', authStore.user);
        isLoggedIn.value = true; // Giriş durumunu true olarak ayarla
      } else {
        console.error('Giriş başarısız:', authStore.error);
      }
    };
    ...
    const handleRegister = async () => {
      ...
      if (authStore.user) {
        console.log('Kayıt başarılı:', authStore.user);
        isAccountCreated.value = true; // Hesap oluşturma durumunu true olarak ayarla
      } else {
        console.error('Kayıt başarısız:', authStore.error);
      }
    };
